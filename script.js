...
const translations = {
  ...
  en: {
    ...
    navContact: "Contact",
    heroEyebrow: "Web Developer Portfolio",
    heroTitle: "Hi, I'm <span>Ky</span>.",
    heroText:
      "This personal portfolio introduces who I am, the skills I use, the projects I have built, my experience, and how to contact me.",
    viewProjects: "View Projects",
    contactMe: "Contact Me",
    interestLabel: "Current Focus",
    focusTitle: "Frontend Development",
    interestText: "I build interactive websites with HTML, CSS, and JavaScript.",
    aboutTitle: "About Me",
    aboutTextOne:
      "I am a growing web developer who enjoys turning small ideas into real screens and working features.",
    aboutTextTwo:
      "I care about clean code, intuitive design, and responsive layouts, and I keep improving by building projects.",
    skillsTitle: "Skills I Use",
    projectsTitle: "Projects",
    projectOneText: "A personal portfolio website that presents my introduction, skills, and projects.",
    projectTwoText: "A responsive landing page design project for introducing a product or service.",
    ...
    experienceTwoTitle: "Web Development Practice",
    experienceTwoText:
      "Building small projects while learning responsive layout, accessibility, and user-focused interfaces.",
